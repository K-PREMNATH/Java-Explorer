...
/*
        ...
        Stripe.apiKey = "sk_test_XXXXXXXXXXXXXXX";
        ...
        get("/configg", (request, response) -> {
            ...
            responseData.put("publicKey", "pk_test_xxxxxxxxxxxxxxxxxx");
        ...
        post("/create-payment-intentt", (request, response) -> {
            ...
            return gson.toJson(new CreatePaymentResponse("pk_test_xxxxxxxxxxxxxxxx", intent.getClientSecret()));
        });
    }*/
    }
}